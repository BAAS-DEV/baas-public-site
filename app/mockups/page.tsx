...
export default function Industries() {
  ...
  return (
    <>
      ...
      <div className="grid xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 w-full gap-2 mb-96 mt-24 px-4">
        {pageLocalState.map((item, i) => (
          <>
            ...
            <div className="card mx-auto w-full hover:bg-base-300 hover:cursor-pointer">
              <Link href={`/mockups/${item.attributes.Title}`}>
                <div className="card bg-base-100 px-4 h-96 sm:96 md:60 shadow-xl">
